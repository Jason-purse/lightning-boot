...
public class SwitchUtil {
    ...
    public static <T, R> Function<T, R> switchMapFuncForTrue(Predicate<T> predicate, Function<T, R> trFunction) {
        return switchMapFunc(predicate, trFunction, () -> null);
    }

    // 条件成假,否则 null
    public static <T, R> Function<T, R> switchMapFuncForFalse(Predicate<T> predicate, Function<T, R> frFunction) {
        return switchMapFunc(predicate, ele -> null, frFunction);
    }
