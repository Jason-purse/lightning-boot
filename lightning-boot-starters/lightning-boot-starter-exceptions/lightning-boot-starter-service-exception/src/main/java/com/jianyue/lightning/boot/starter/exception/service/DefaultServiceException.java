...
import com.jianyue.lightning.boot.starter.exception.dao.AbstractDaoException;
import com.jianyue.lightning.exception.AbstractApplicationException;

import static com.jianyue.lightning.boot.starter.exception.service.ServiceExStatusConstant.SERVICE_EX_STATUS_CONSTANT;
...
public class DefaultServiceException extends AbstractApplicationException {
    ...
    public DefaultServiceException(String message, AbstractDaoException cause) {
        super(SERVICE_EX_STATUS_CONSTANT.value(), message, cause);
    }
